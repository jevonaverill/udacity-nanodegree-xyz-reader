...
public class ArticleListActivity extends AppCompatActivity
  ...
  public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
    ...
    // Snackbar showing load data is finished
    final Snackbar snackbar = Snackbar.make(mRecyclerView, "Load Finished", Snackbar.LENGTH_LONG);
    snackbar.setActionTextColor(Color.CYAN).setAction("Refresh", new View.OnClickListener() {
      @Override
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
      ...
      if (!publishedDate.before(START_OF_EPOCH.getTime())) {
        holder.subtitleView.setText(Html.fromHtml(DateUtils
            ...
            .toString() + "<br/>" + " by " + mCursor.getString(ArticleLoader.Query.AUTHOR)));
      } else {
        holder.subtitleView.setText(Html.fromHtml(outputFormat.format(publishedDate) + "<br/>"

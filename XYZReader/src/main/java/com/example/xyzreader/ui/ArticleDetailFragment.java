...
public class ArticleDetailFragment extends Fragment
      ...
      public void onClick(View view) {
        startActivity(
            Intent.createChooser(ShareCompat.IntentBuilder.from(getActivity()).setType("text/plain")
                .setText("Some sample text").getIntent(), getString(R.string.action_share)));
      }
    });
  ...
  private void bindViews() {
    ...
    StringBuilder sbArticleByLine = new StringBuilder();
    String openFontColorTag = " by <font color='#ffffff'>";
    String closeFontColorTag = "</font>";
    ...
    if (mCursor != null) {
      ...
      if (!publishedDate.before(START_OF_EPOCH.getTime())) {
        ...
        sbArticleByLine.append(relativeTimeSpan).append(openFontColorTag)
            .append(mCursor.getString(ArticleLoader.Query.AUTHOR)).append(closeFontColorTag);
        bylineView.setText(Html.fromHtml(sbArticleByLine.toString()));

      } else {
        // If date is before 1902, just show the string
        sbArticleByLine.append(outputFormat.format(publishedDate)).append(openFontColorTag)
            .append(mCursor.getString(ArticleLoader.Query.AUTHOR)).append(closeFontColorTag);
        bylineView.setText(Html.fromHtml(sbArticleByLine.toString()));
      }
